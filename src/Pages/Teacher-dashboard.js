  ...
  return (
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <ul className="menu">
          <li className="active" onClick={()=>{navigate("/teacher_dashboard")}}>🏠 Dashboard</li>
          <li
            onClick={() => {
              navigate("create_form");
            }}><FaPlus /> Create Form</li>
          {/* <li><FaTable /> Manage Forms</li> */}
           <li
            onClick={() => {
              navigate("view_form");
            }}><VscPreview/> View Form</li>
          <li 
           onClick={() => {
              navigate("teacher_profile");
            }}><FaUser /> Profile</li>
          <li 
          onClick={()=>setShowLogout(true)}><RiLogoutBoxRFill />Logout</li>
        </ul>
      </aside>
